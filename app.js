...
const state={role:'admin',user:'قاسم',trip:'مدیریت سفر خانوادگی',pendingMembers:[],members:[],expenses:[],locations:[],itinerary:[],shareAmount:12000000,settlementEnabled:false};
