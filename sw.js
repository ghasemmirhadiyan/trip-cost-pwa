const CACHE='trip-pwa-v15-2';
const ASSETS=['./','./index.html','./styles.css?v=15.2','./supabase-config.js?v=15.2','./auth.js?v=15.2','./app.js?v=15.2','./manifest.webmanifest','./assets/north-login-bg.png','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
