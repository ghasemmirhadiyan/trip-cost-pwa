const CACHE='trip-pwa-v14-1';
const ASSETS=['./','./index.html','./styles.css?v=14.1','./supabase-config.js?v=14.1','./auth.js?v=14.1','./app.js?v=14.1','./manifest.webmanifest','./assets/north-login-bg.png','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
