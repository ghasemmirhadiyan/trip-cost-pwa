const CACHE='trip-pwa-v14-6';
const ASSETS=['./','./index.html','./styles.css?v=14.9','./supabase-config.js?v=14.9','./auth.js?v=14.9','./app.js?v=14.9','./manifest.webmanifest','./assets/north-login-bg.png','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
