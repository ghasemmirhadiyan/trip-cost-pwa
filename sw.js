const CACHE='trip-pwa-v14-5';
const ASSETS=['./','./index.html','./styles.css?v=14.5','./supabase-config.js?v=14.5','./auth.js?v=14.5','./app.js?v=14.5','./manifest.webmanifest','./assets/north-login-bg.png','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
