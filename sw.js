...
const ASSETS=['./','./index.html','./styles.css?v=15.7','./supabase-config.js?v=15.7','./auth.js?v=15.7','./app.js?v=15.7','./manifest.webmanifest','./assets/north-login-bg.png','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
