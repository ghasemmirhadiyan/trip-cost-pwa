const CACHE='trip-pwa-v13-6';
const ASSETS=['./','./index.html','./styles.css?v=13.6','./supabase-config.js?v=13.6','./auth.js?v=13.6','./app.js?v=13.6','./manifest.webmanifest','./assets/north-login-bg.png','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
