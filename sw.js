const CACHE='trip-pwa-v13-7';
const ASSETS=['./','./index.html','./styles.css?v=13.7','./supabase-config.js?v=13.7','./auth.js?v=13.7','./app.js?v=13.7','./manifest.webmanifest','./assets/north-login-bg.png','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
