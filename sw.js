...
const ASSETS=['./','./index.html','./styles.css?v=14.8','./supabase-config.js?v=14.8','./auth.js?v=14.8','./app.js?v=14.8','./manifest.webmanifest','./assets/north-login-bg.png','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
