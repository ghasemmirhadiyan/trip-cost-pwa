...
const ASSETS=['./','./index.html','./styles.css?v=15.0','./supabase-config.js?v=15.0','./auth.js?v=15.0','./app.js?v=15.0','./manifest.webmanifest','./assets/north-login-bg.png','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
