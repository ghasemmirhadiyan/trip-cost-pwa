const CACHE='trip-pwa-v15-4';
const ASSETS=['./','./index.html','./styles.css?v=15.4','./supabase-config.js?v=15.4','./auth.js?v=15.4','./app.js?v=15.4','./manifest.webmanifest','./assets/north-login-bg.png','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
