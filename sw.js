const CACHE='trip-pwa-v13-5';
const ASSETS=['./','./index.html','./styles.css?v=13.5','./supabase-config.js?v=13.5','./auth.js?v=13.5','./app.js?v=13.5','./manifest.webmanifest','./assets/north-login-bg.png'];
