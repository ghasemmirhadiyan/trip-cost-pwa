const CACHE='trip-pwa-v15-6';
const ASSETS=['./','./index.html','./styles.css?v=15.6','./supabase-config.js?v=15.6','./auth.js?v=15.6','./app.js?v=15.6','./manifest.webmanifest','./assets/north-login-bg.png','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
